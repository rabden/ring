export const modelConfig = {
  ...
  midjourney2: {
    ...
    promptSuffix: " ``",
    tagline: "Latest version of Midjourney for free",
    image: "https://i.ibb.co.com/4pfMnCH/images-example-wbu24jq33.jpg",
  ...
  logodesign3: {
    ...
    image: "https://i.ibb.co.com/rQSRVhn/901910c0-db8e-4f86-9cd2-6c97f3664175.jpg",
    example: "Start with 'Logo' Then describe the logo to appear in the image",
    steps: 28,
    use_guidance: false,
    defaultguidance: 5,
  ...
  logodesign4: {
    ...
    promptSuffix: null,
    tagline: "Make your brand Identity 3",
    image: "https://i.ibb.co.com/VTP3NLz/LD2.png",
  ...
  Isometric: {
    ...
    example: "Start with 'Isometric 3D, a 3D model of' Then describe the things to appear in the image, heres an example: 'Isometric 3D, a 3D model of a tropical islan
d is displayed on a light blue backdrop. The island features a small body of water, surrounded by gray rocks and green grass. There are palm trees and small bushes scattered throughout the island, adding a pop of color to the scene.'",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
    use_negative_prompt: false,
  ...
  animeturbo: {
    ...
    promptSuffix: ", Anime",
    tagline: "Anime style images make fast",
    image: "https://i.ibb.co.com/Jc6gPQL/example-577074pi1.jpg",
    example: "Make high quality flawless prompt,  provide fine details like environment, lighting, colors, visual elements, if included charachters then styling, clothings, appearance, activity e.t.c",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
  ...
  animexl: {
    ...
    image: "https://i.ibb.co.com/RjjGX1V/e36eeebd-2556-4258-9b32-3407fec3b0c6.jpg",
    example: "Make high quality flawless prompt,  provide fine details like environment, lighting, colors, visual elements, if included charachters then styling, clothings, appearance, activity e.t.c",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
  ...
  ghiblianime: {
    ...
    tagline: "Modern Anime style images make",
    image: "https://i.ibb.co.com/x6r9FVK/example7.jpg",
