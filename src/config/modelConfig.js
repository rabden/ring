export const modelConfig = {
  ...
  midjourney2: {
    ...
    example: "Make high quality flawless prompts that will go well wth Midjourney, use quality and style tags like: high quality, studio lighting, professional portrait, e.t.c keep it short yet detailed, provide fine details like environment, lighting, colors, visual elements, if included charachters then styling, clothings, appearance, activity e.t.c. End with '--ar 47:64 --v 6.0 --style raw' if making a portrait, else not add this is an example: 'MJ v6, A photo of an attractive man in his thirties, wearing a black coat and yellow scarf with a brown pattern inside a building talking on a phone standing near a modern glass skyscraper in London, shot from below looking up at him in the style of street photography, cinematic.  --ar 85:128 --v 6.0 --style raw'",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
    use_negative_prompt: false,
  ...
  logodesign3: {
    ...
    isPremium: false,
    promptSuffix: null,
    tagline: "Make your brand Identity 3",
  ...
  logodesign4: {
    ...
    example: "Start with 'Logo' Then describe the logo to appear in the image, keep it minimal and short prompt to create minimal logo against white background",
    steps: 28,
    use_guidance: false,
    defaultguidance: 5,
    use_negative_prompt: false,
  ...
  fastReal: {
    ...
    image: "https://i.ibb.co/JrYsbmT/SD3.webp",
  ...
  animeturbo: {
    ...
    category: "General",
    group: "Anime",
    apiUrl: "https://api-inference.huggingface.co/models/NeurixYUFI/Neurix-Anime",
    qualityLimits: null,
    isPremium: false,
    promptSuffix: ", Anime",
    tagline: "Anime style images make fast",
    image: "https://i.ibb.co/Jc6gPQL/example-577074pi1.jpg",
    example: "make sure the prompt excels in making Anime style images, add any word tags that might enhance or indicate to Anime styles.",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
  ...
  animexl: {
    ...
    category: "General",
    group: "Anime",
    apiUrl: "https://api-inference.huggingface.co/models/Jovie/Anime5",
    qualityLimits: null,
    isPremium: false,
    promptSuffix: ", Anime",
    tagline: "Modern Anime style images make",
    image: "https://i.ibb.co/RjjGX1V/e36eeebd-2556-4258-9b32-3407fec3b0c6.jpg",
    example: "make sure the prompt excels in making Anime style images, add any word tags that might enhance or indicate to Anime styles.",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
  ...
  undraw: {
    ...
    image: "https://i.ibb.co/KX7cFBC/4b22ca52-c8ad-43e3-8690-4961570020b4.jpg",
  ...
  graphic: {
    ...
    image: "https://i.ibb.co/njB3kD2/3335a4b8-c787-43ef-81fa-8f2b27568740.jpg",
  ...
  disney: {
    ...
    image: "https://i.ibb.co/54bxzMk/4058459.jpg",
