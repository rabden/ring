export const modelConfig = {
  ...
  ghiblianime: {
    ...
    example: "Make high quality flawless prompt for GHIBSKY style painting images,  provide fine details like environment, lighting, colors, visual elements, if included charachters then styling, clothings, appearance, activity e.t.c",
    steps: 28,
    use_guidance: false,
    defaultguidance: 7.5,
    use_negative_prompt: false,
