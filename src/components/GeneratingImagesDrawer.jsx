...
const GeneratingImagesDrawer = ({ open, onOpenChange }) => {
  ...
  // Component to render images in both drawer and dropdown
  const GeneratingImagesList = () => (
  ...
  // Define the header title based on processing state
  const headerTitle = processingCount > 0 ? (
